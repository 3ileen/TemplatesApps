...
import { signInWithOAuthInAppBrowser } from "../../../lib/auth/oauth";
...
export default function Auth() {
  ...
  async function signInWithGoogle() {
    try {
      setLoading(true);
      await signInWithOAuthInAppBrowser("google");
    } catch (e: any) {
  ...
  async function signInWithApple() {
    try {
      ...
      // Apple throws an error when user cancels.
              ...
              <View className="mb-6">
                <TouchableOpacity
                  className={`rounded-lg py-4 px-6 mb-3 ${
                    loading ? "bg-gray-300" : "bg-white border border-gray-300"
                  }`}
